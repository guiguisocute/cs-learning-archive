package xuexitong_test.week_9.p3;
//TODO: 设计能存储char型数据的链式二叉树结构，并实现前/中/后序的递归遍历，前/中/后序非递归遍历。
        ...
        while(!stack.isEmpty() || current != null){
            ...
            if (!stack.isEmpty()) {
                ...
                if (t == 0) { // 如果左子树未访问
                    ...
                    stack.tag[stack.top - 1] = 1; // 标记为右子树未访问,意思是：“你（pop）了我，发现我的 tag=0。这说明我的左边刚处理完。把我重新压栈，把我的 tag 设为1，然后去探索我的右边。”
